---@class EditorShapes: SKMEState
local EditorShapes, super = Class("SKMEState")
...
---@return EditorEvent?
function EditorShapes:detectObject(x, y)
...
function EditorShapes:onMousePressed(x, y, button)
...
function EditorShapes:selectObject(obj)
...
function EditorShapes:onMouseReleased()
    self.grabbing = false
end
